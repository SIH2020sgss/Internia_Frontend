...
class Profile extends React.Component {
  render() {
    return (
      <div className="container-fluid bg-light mx-auto p-4 vh-100" id="profile">
        <div
        ...
        <div
          className="container shadow-sm mx-auto bg-white p-3 row  mt-4"
          style={{ borderRadius: "0.9em" }}
        >
          <div className="col-md-3 bg-white p-1 mr-1">Sidebar</div>
          <div className="col-md-7 bg-white p-1">Main content</div>
        </div>
      </div>
    );
  }
